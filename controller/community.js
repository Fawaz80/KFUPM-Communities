...
async function createCommunity(req, res) {
    try {
        const { comName, comBio, comIcon, owner, members } = req.body;
        const newCommunity = new Community({ comName, comBio, comIcon, owner, members });
...
async function updateCommunityById(req, res) {
    try {
        const { comName, comBio, comIcon, owner, members, posts, events, materials } = req.body;
